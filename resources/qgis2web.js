...
map.getView().fit([217555.583323, 797980.433522, 226044.202756, 804038.527862], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sites_religieux (QFieldCloud)</h2>';
        return titleElement;
    })(),
